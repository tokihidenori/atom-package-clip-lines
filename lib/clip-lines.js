...
export default {
  ...
  copy() {
    ...
    notIncludeRootInPath = atom.config.get('clip-lines.notIncludeRootInPath');
    includeFilepathInSyntaxMarkDownHighlight = atom.config.get('clip-lines.includeFilepathInSyntaxMarkDownHighlight');

    filePath = editor.getPath();
    if (notIncludeRootInPath) {
    ...
    if (enableMarkDownFormat) {
      if (includeFilepathInSyntaxMarkDownHighlight) {
